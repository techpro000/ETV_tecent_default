...
// * 定时开关机检测时间得线程
// */
//public class CheckTimeRunnable_0121 implements Runnable {
//
//    EtvServerListener listener;
//    Context context;
//
//    public CheckTimeRunnable_0121(Context context, EtvServerListener listener) {
...
////            }
////            parsenerTimerTask(listTimer);
//            parsenerTimerTask(null);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//    }
//
//    private final int TIME_ADD_ON = 300;
//    private final int TIME_ADD_OFF = 100;
//
//    private void parsenerTimerTask(List<ScheduleRecord> listTimer) {
//        String OnTime = SystemManagerInstance.getInstance(context).getPowerOnTime() + "00";
//        String OffTime = SystemManagerInstance.getInstance(context).getPowerOffTime() + "00";
//        long currentTimeLong = SimpleDateUtil.getCurrentTimelONG();
//        MyLog.powerOnOff("===上一次设定得开关机时间==" + OffTime + " / " + currentTimeLong + " / " + OnTime);
//        //当前开机时间小于关机时间
//        //判断当前时间只要在 开关机时间之内就可以
//        //这里提前三分钟，防止不开机，关机后一分钟的时间误差
//        Long powerOnTime = Long.parseLong(OnTime) - TIME_ADD_ON;
//        Long powerOffTime = Long.parseLong(OffTime) + TIME_ADD_OFF;
...
////            MyLog.powerOnOff("===offTime====" + offTime + " = " + onTime);
////            listTimeCompair.add(new TimeComparEntity(onTime, offTime, saveOnTime, saveOffTime));
////        }
////        //时间按照从小到大排序
////        listTimeCompair = BubbleUtil.sortByTime(listTimeCompair, true);
////        long currentTimeLong = SimpleDateUtil.getCurrentTimelONG();
...
////            logInfo("计算开关机时间======便利开机时间String==" + ppowerOffTimeString + " /当前时间=" + currentTimeLong + " /开机时间==" + powerOnTimeString);
////            long powerOnTime = Long.parseLong(powerOnTimeString);
////            long powerOffTime = Long.parseLong(ppowerOffTimeString);
////            if (powerOnTime < powerOffTime) {
////                logInfo("计算开关机时间======开机时间 < 关机时间====跨天操作=");
////                //当前开机时间小于关机时间
////                //判断当前时间只要在 开关机时间之内就可以
////                //这里提前三分钟，防止不开机，关机后一分钟的时间误差
////                long onTimeCompair = powerOnTime - TIME_ADD_ON;
////                long offTimeCompair = powerOffTime + TIME_ADD_OFF;
...
////                    isShutTime = false;
////                    logInfo("计算开关机时间===判断时间==false==" + "开机 < 关机 条件符合00=" + offTimeCompair + "/" + currentTimeLong + " / " + onTimeCompair);
////                    break;
////                }
////                long current00Time = SimpleDateUtil.getCurrentDay00Time();
////                if (currentTimeLong < onTimeCompair && currentTimeLong > current00Time) {
////                    isShutTime = false;
////                    logInfo("计算开关机时间===判断时间==false==" + "开机 < 关机 条件符合111=" + offTimeCompair + "/" + currentTimeLong + " / " + onTimeCompair);
////                    break;
////                }
////            } else {
////                //  一天之内得 正常定时开关机设置
...
////            }
////        }
////        logInfo("计算开关机时间==当前时间开关机状态==" + isShutTime);
////        if (isShutTime) {
